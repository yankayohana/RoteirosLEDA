...
public class ThreeWayQuickSort<T extends Comparable<T>> extends
	...
	public void sort(T[] array, int leftIndex, int rightIndex) {
		if (array != null && leftIndex >= 0 && rightIndex < array.length && rightIndex >= leftIndex
				&& array.length != 0) {
			threeWay(array, leftIndex, rightIndex);
		
		}
	}
	
	private void threeWay(T[] array, int leftIndex, int rightIndex) {
		...
		if (leftIndex < rightIndex) {
			...
			threeWay(array, leftIndex, i - 1);
			threeWay(array, j + 1, rightIndex);
		}
